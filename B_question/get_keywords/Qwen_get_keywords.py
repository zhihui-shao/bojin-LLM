        ...
        "messages": [
            {
                ...
                "content": f'''
                        ...
                        首先分析句子的组成结构，然后提取出完整的主语，谓语，宾语，时间名词，地点名词等等。
                        如果句子中出现了时间，则关键词一定要包括表示时间的名词和公司名称。
                        ...
                        用户输入：本次发行前，大连派思燃气系统股份有限公司的控股股东持有公司的多少股份？占公司总股份的多少？
                        本次发行前、大连派思燃气系统股份有限公司、控股股东、总股份
