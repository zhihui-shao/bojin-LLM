        ...
        "messages": [
            {
                ...
                "content": f'''
                        ...
                        各报告期末、江苏旷达汽车织物集团股份有限公司、存货、流动资产
                        ...
                        用户输入：截至2020年12月31日，湖南长远锂科股份有限公司的控股股东是谁？通过何种方式持有公司多少股权？
                        2020年12月31日、湖南长远锂科股份有限公司、控股股东、股权
...
for obj in datas: 
    ...
    if id > 437:
        ...
        output_file = "B_keywords_1130.json"    # 每次循环迭代都将结果追加到JSON文件
