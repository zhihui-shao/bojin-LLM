...
def get66th(answer):
    if "一" in answer:
        answer = answer.replace("一", "01-01", 1)
        answer = answer.replace("一", "03-31", 1)
    elif "二" in answer:
        answer = answer.replace("二", "04-01", 1)
        answer = answer.replace("二", "06-30", 1)
    elif "三" in answer:
        answer = answer.replace("三", "07-01", 1)
        answer = answer.replace("三", "10-30", 1)
    elif "四" in answer:
        answer = answer.replace("四", "11-01", 1)
        answer = answer.replace("四", "12-31", 1)
    return answer
